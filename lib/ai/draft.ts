...
בדיקה עצמית — לפני שאתה מחזיר את הכתבה, עבור על כל פסקה ושאל את עצמך:
• האם כל שם, תאריך ומספר כאן נכון ומתועד?
• האם המצאתי ציטוט או אירוע שלא קיים?
• האם יש כאן סטטיסטיקה שאני לא באמת בטוח בה?
אם משהו לא עובר את הבדיקה — תקן אותו, החלף ב-[לבדיקה], או מחק את המשפט. עדיף כתבה קצרה יותר אבל מדויקת לחלוטין.${
